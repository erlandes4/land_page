...
export default function Dashboard() {
  ...
  return (
      <div className="flex h-screen bg-slate-50 dark:bg-slate-950 font-sans overflow-hidden transition-colors duration-300">
        <aside className="w-64 bg-blue-950 dark:bg-slate-900 text-white hidden md:flex md:flex-col rounded-r-[40px] shadow-2xl z-20 my-4 ml-4 overflow-hidden relative transition-colors duration-300">
        ...
        <main className="flex-1 flex flex-col h-screen overflow-hidden">
          <header className="p-6 sm:p-8 flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto justify-end">
              <button onClick={toggle} className="p-2.5 rounded-full bg-white dark:bg-slate-800 text-slate-600 dark:text-amber-400 shadow-sm border border-slate-100 dark:border-slate-700 hover:scale-110">{isDark ? '☀️' : '🌙'}</button>
            ...
            {abaAtiva === 'prospeccao' && (
              <div className="space-y-8 animate-in fade-in duration-500">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="bg-linear-to-br from-blue-900 to-blue-800 p-6 rounded-3xl shadow-lg text-white relative overflow-hidden"><span className="text-blue-200 text-sm font-semibold mb-1 block">Mensal (MRR)</span><div className="text-3xl font-extrabold">R$ {receitaRecorrente.toLocaleString('pt-BR')}</div></div>
                  <div className="bg-linear-to-br from-emerald-600 to-emerald-500 p-6 rounded-3xl shadow-lg text-white relative overflow-hidden"><span className="text-emerald-100 text-sm font-semibold mb-1 block">Avulsa (Única)</span><div className="text-3xl font-extrabold">R$ {receitaAvulsa.toLocaleString('pt-BR')}</div></div>
                       ...
                       <div className="p-6 flex-1 flex flex-col">
                         <div className="flex items-start gap-4 w-full mb-4">
                           ...
                           <div className="flex-1 flex flex-col w-full">
                             ...
                             <textarea 
                               className="w-full flex-1 min-h-20 p-3 border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 rounded-2xl text-xs outline-none resize-none text-slate-900 dark:text-slate-100 placeholder:text-slate-400" 
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-4xl overflow-hidden animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
                ...
                <div className="flex flex-col md:flex-row flex-1 overflow-auto">
                  ...
                  <div className="w-full md:w-1/2 bg-slate-50 dark:bg-slate-950 p-6 md:p-8 flex flex-col">
                    <label className="flex text-xs font-bold text-slate-400 uppercase tracking-wider mb-4 items-center gap-2"><IconeWhatsApp /> Pré-visualização</label>
